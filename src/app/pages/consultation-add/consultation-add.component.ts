...
export class ConsultationAddComponent implements OnInit {
  ...
  openModal() {
    const modalRef = this.modalService.open(MedicationAddModalComponent,{});
    modalRef.componentInstance.medication = this.medication;
    modalRef.componentInstance.passEntry.subscribe((medicationData: MedicationModel) => {
      this.medicationService.save(medicationData).subscribe((data : MedicationModel)=>{
